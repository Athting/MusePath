    ...
    <>
      {generating && (
        <div className="generating-overlay">
          <div className="page-style-180">
            <div className="generating-spinner" />
            <div className="page-style-181">
              {''}
            </div>
          </div>
          ...
          <div className="page-style-182">
            {stepsLabels.map((t) => (
              <div key={t} className="page-style-183">
                {t}
              </div>
            ))}
          </div>
      ...
      <div className="onboarding-container">
        ...
        <div className="onboarding-card animate-scale-in">
          ...
          <div className="flex items-center gap-3 mb-6">
            <div className="page-style-184">
              M
            </div>
            <span className="page-style-185">
              MusePath
            </span>
          </div>
          ...
          <div className="flex items-center justify-between mt-8">
            ...
            <button onClick={next} disabled={!isValid() || generating} className="btn btn-primary page-style-187">
              {step === STEPS.length - 1 ? (<> <Sparkles size={16} /> Generate My Plan </>) : (<> Continue <ArrowRight size={16} /> </>)}
            </button>
          </div>
        </div>
      </div>
